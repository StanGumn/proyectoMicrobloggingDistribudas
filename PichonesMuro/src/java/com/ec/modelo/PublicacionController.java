...
import com.ec.entidades.Publicacion;
import com.ec.modelo.util.JsfUtil;
import com.ec.modelo.util.JsfUtil.PersistAction;
import com.ec.sesion.PublicacionFacade;
...
public class PublicacionController implements Serializable {
    ...
    @EJB
    private com.ec.sesion.PublicacionFacade ejbFacade;
