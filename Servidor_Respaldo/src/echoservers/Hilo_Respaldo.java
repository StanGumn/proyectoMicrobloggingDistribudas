...
public class Hilo_Respaldo extends Thread {

    long threadID;
    Socket client;

    Hilo_Respaldo(Socket client) {
        this.client = client;
    }

    public void insertarPublicacion(String descripconPublicacion, String geo) {
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("Servidor_RespaldoPU");
