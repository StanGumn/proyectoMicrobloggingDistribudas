...
public class Hilo_Cuenca extends Thread {

    long threadID;
    Socket client;

    Hilo_Cuenca(Socket client) {
        this.client = client;
    }

    public void insertarPublicacion(String descripconPublicacion, String geo) {
        try {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("Servidor_CuencaPU");
